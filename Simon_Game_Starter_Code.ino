//STEP 1: Declare arrays button[] and led[] to store Arduino pins for those components
int button[] = /*FILL THIS IN*/
int led[] = /*FILL THIS IN*/
...
void setup() {
  //STEP 2: set all of the button pins to INPUT_PULLUP
  for(int i = 0; i < 4; i++)
  {
    pinMode(/*FILL THIS IN*/);
  }

  //STEP 3: set all of the LED pins to output
  for(int i = 0; i < 4; i++)
  {
    pinMode(/*FILL THIS IN*/);
  }
  //STEP 4: set the buzzer pin to output
  pinMode(/*FILL THIS IN*/);
}
...
//TURN ALL LEDS OFF
void allLEDoff () {
  //STEP 5: turn all the LEDs off
  for(int i = 0; i < 4; i++)
  {
    digitalWrite(/*FILL THIS IN*/);
  }
...
void startSequence() {
  ...
  for (int i = 0; i <= 3; i++) {
    ...
    //STEP 6: Turn all the LEDs on, then wait a moment, then turn all the LEDs off, then wait a moment
    for(int i = 0; i < 4; i++)
    {
      digitalWrite(/*FILL THIS IN*/);
    }
